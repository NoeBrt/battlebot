/* ============================================================================
 * RLBotSecondary.java — RL-optimized secondary/scout bot (2 per team).
...
public class RLBotSecondary extends RLBotBase {
    ...
    public void activate() {
        ...
        if (NBOT.equals(id)) {
            ...
            flankY = RLConfig.FLANK_Y_OFFSET;
        } else {
            ...
            flankY = MAP_H - RLConfig.FLANK_Y_OFFSET;
        }

        advanceX = teamA ? RLConfig.ADVANCE_X_A : (MAP_W - RLConfig.ADVANCE_X_A);
    ...
    public void step() {
        ...
        if (getHealth() < maxHP * RLConfig.HP_RETREAT_PCT_SEC && state != S.RETREATING && state != S.DEAD) {
    ...
    private void executePatrol() {
        if (!enemies.isEmpty()) {
            ...
            if (minDist < RLConfig.PATROL_EVASION_RANGE) {
