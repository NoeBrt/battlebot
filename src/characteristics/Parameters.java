...
public class Parameters {
  ...
  //---TEAM-B-PARAMETERS---//
  //-----------------------//
  public static final String teamBName = "Yomi";
  public static final String teamBMainBotBrainClassName = "algorithms.home.Main"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.home.Secondary"; //class given by name; is supposed to extends robotsimulator.Brain
