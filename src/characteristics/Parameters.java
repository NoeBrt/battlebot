...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAName = "Bilgewater";
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.LLMS.ClaudeMain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.LLMS.ClaudeSecondary"; //class given by name; is supposed to extends robotsimulator.Brain
