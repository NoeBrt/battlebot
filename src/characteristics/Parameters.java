...
public class Parameters {
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.lab.MultiAction"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.lab.MultiAction"; //class given by name; is supposed to extends robotsimulator.Brain
