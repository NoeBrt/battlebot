...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAMainBotBrainClassName = "algorithms.external.MacDuoMain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.external.MacDuoSecondary"; //class given by name; is supposed to extends robotsimulator.Brain
 ...
 //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.lab.NoeSecondaryBot"; //class given by name; is supposed to extends robotsimulator.Brain
