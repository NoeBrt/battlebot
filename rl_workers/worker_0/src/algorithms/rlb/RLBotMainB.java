...
public class RLBotMainB extends RLBotBaseB {
    ...
    public void activate() {
        ...
        holdX = teamA ? RLConfigB.HOLD_X_OFFSET : (MAP_W - RLConfigB.HOLD_X_OFFSET);
    ...
    public void step() {
        ...
        if (!isAvoiding() && state != S.DEAD) {
            if (getHealth() < RLConfigB.HP_RETREAT_MAIN && enemies.isEmpty()) {
                state = S.RETREATING;
            } else if (!enemies.isEmpty()) {
                state = (noFireTicks > RLConfigB.NOFIRE_REPOSITION_TICKS) ? S.FLANKING : S.FIRING;
            } else {
                state = S.ADVANCING;
            }
        }
