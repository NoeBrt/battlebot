...
public class RLBotMain extends RLBotBase {
    ...
    public void activate() {
        ...
        holdX = teamA ? RLConfig.HOLD_X_OFFSET : (MAP_W - RLConfig.HOLD_X_OFFSET);
    ...
    public void step() {
        ...
        if (!isAvoiding() && state != S.DEAD) {
            if (getHealth() < RLConfig.HP_RETREAT_MAIN && enemies.isEmpty()) {
                state = S.RETREATING;
            } else if (!enemies.isEmpty()) {
                state = (noFireTicks > RLConfig.NOFIRE_REPOSITION_TICKS) ? S.FLANKING : S.FIRING;
            } else {
                state = S.ADVANCING;
            }
        }
