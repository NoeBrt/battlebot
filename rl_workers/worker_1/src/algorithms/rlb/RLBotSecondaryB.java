/* ============================================================================
 * RLBotSecondaryB.java — RL-optimized secondary/scout bot (2 per team).
...
public class RLBotSecondaryB extends RLBotBaseB {
    ...
    public void activate() {
        ...
        if (NBOT.equals(id)) {
            ...
            flankY = RLConfigB.FLANK_Y_OFFSET;
        } else {
            ...
            flankY = MAP_H - RLConfigB.FLANK_Y_OFFSET;
        }

        advanceX = teamA ? RLConfigB.ADVANCE_X_A : (MAP_W - RLConfigB.ADVANCE_X_A);
    ...
    public void step() {
        ...
        if (getHealth() < maxHP * RLConfigB.HP_RETREAT_PCT_SEC && state != S.RETREATING && state != S.DEAD) {
    ...
    private void executePatrol() {
        if (!enemies.isEmpty()) {
            ...
            if (minDist < RLConfigB.PATROL_EVASION_RANGE) {
